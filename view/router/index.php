...
<a href="<?php echo HOST ?>router-new"><button class="btn btn-primary">New</button></a>
    ...
    <tr>
      ...
      <td>
            <ul>
                ...
                <a class="btn btn-primary" href="<?php path('router-sho?idrouter' . $rshow['idrouter']) ?>">  Ver </a>            
            </ul>
        </td>
        </tr>
        <?php } ?>
